...
export function GlassyGreyLandingPage() {
  return (
      ...
      <div className="backdrop-blur-sm bg-white/30">
        ...
        <main className="container mx-auto px-4 py-20">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-800 mb-4">Find Your Perfect Legal Match</h1>
            <p className="text-xl text-gray-600 mb-8">Connect with top-rated lawyers tailored to your needs</p>
          </div>

          <div className="max-w-4xl mx-auto backdrop-blur-md bg-white/40 rounded-lg p-2 shadow-lg">
            <div className="flex flex-col md:flex-row">
              <div className="flex-grow flex items-center bg-white/60 rounded-lg p-2 mb-2 md:mb-0 md:mr-2 shadow-sm">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            {[
              ...
              <div key={index} className="backdrop-blur-md bg-white/40 rounded-lg p-6 text-gray-800 shadow-lg">
          ...
          <div className="mt-20 text-center">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
              {[
                ...
                <div key={index} className="flex items-center backdrop-blur-md bg-white/40 rounded-lg p-4 shadow-md">
        ...
        <footer className="container mx-auto px-4 py-8 mt-20 border-t border-gray-300">
